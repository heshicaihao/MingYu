...
public class CalendarPickerView extends ListView
{
	...
	final MonthView.Listener cellClickedListener = new CellClickedListener();
	...
	public CalendarPickerView(Context context, AttributeSet attrs) {
		...
		titleTextColor = a.getColor(
				...
				res.getColor(R.color.calendar_whitetext_active));
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			if (monthView == null)
			{
				monthView = MonthView.create(parent, inflater,
						weekdayNameFormat, cellClickedListener, today, dividerColor,
