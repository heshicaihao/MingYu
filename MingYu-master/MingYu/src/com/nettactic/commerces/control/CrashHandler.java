...
import com.nettactic.commerces.activity.MingYuActivity;
...
public class CrashHandler implements UncaughtExceptionHandler
{
	...
	public void uncaughtException(Thread thread, Throwable ex)
	{
		...
		} else
		{
			...
			if (MyConfig.ifDebug)
			{
				LogUtil.e(TAG, "%%%%%%%%%%%%%%%" + mContext.toString());
			}
			Intent intent = new Intent(mContext, MingYuActivity.class);
	...
	public void collectDeviceInfo(Context ctx)
	{
		...
		if (MyConfig.ifDebug)
		{
			LogUtil.e(TAG, "%%%%%%%%%%%%%%%%collectDeviceInfo");
		}
		try
		{
	...
	private String saveCrashInfo2File(Throwable ex)
	{
		...
		try
		{
			...
			String fileName = "crash-" + "mingyu" + ".log";
